...
public class JellyPagerFragment extends Fragment {
	boolean visible = true;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.jellypager_frag_layout,
				container, false);
		initUI(rootView);
		return rootView;
	}
	...
	private void initUI(View root) {
		...
		int res = bundle.getInt(ContantValue.keyString, R.drawable.a);
