...
public class ClickedEffectImagview extends ImageView {
	...
	public ClickedEffectImagview(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		camera = new Camera();
	}

	public ClickedEffectImagview(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		camera = new Camera();
	}
